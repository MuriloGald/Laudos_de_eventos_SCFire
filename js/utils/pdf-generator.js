    ...
    const drawCaracteristicas = (doc, startY, state, respostas) => {
        ...
        if (state.porteFinal === 'pequeno') {
            mapOrdem = [
                ...
                { key: 'EPPP01' }, { key: 'EPPP02' }, { key: 'EPPP03' }, { key: 'EPPP04' },
                { type: 'header', label: 'Instalações de Gás Combustível' },
                { key: 'GLP01' }, { key: 'GLP02' },
                { type: 'header', label: 'Sistemas e medidas de segurança' },
                { key: 'SMSCIPP01' }, { key: 'SMSCIPP02' }, { key: 'SMSCIPP03' }, { key: 'SMSCIPP04' }, { key: 'SMSCIPP05' }
            ];
